...
**Requirements**
1. Create an index template-10min  
2. Regester it in urls and views-10 min  
3. Add a list of artwork that still needs to be added -20 min  
...
**Requirements**
1. Create an artists list template - 10min
2. Add it to URLs and views - 10 min
...
**Requirements**
1. create an Art view template. - 10 min
2. Add it to URLs and views - 10 min
...
**Requirements**
1. create an edit artwork URL and view  - 10 min
2. add the button to the artwork details button  - 5 min
...
1. add buttons to the Art list page, the Index page, and the Portfolio page - 10 min
...
**Requirements**
1. Regester delete under URLs and views - 10 min
2. Add the delete button to the artwork details page - 10 min
...
3. Add the button to the index list, the Art list, and the Portfolio detail list.  - 10 min
...
3. add a list of that artist's portfolios to it  - 10 min
4. Add a button to view it on the Artist list page.  - 10 min
...
3. Add a button to it on the list of portfolios under Artists details - 10 min
...
**Requirements**
1. create a form for adding art  - 40 min
2. create a template for the page  - 10 min
3. Regester it under views and urls - 10 min
4. connect the button to the top panel - 10 min
...
**Requirements**
1. Create a page for the base template  - 10 min
2. Add an Art button to the top bar and connect it to the Artwork list page - 10 min
...
**Requirements**
1. Add an Artists button to the top bar and connect it to the artists list. - 10 min
...
**Requirements**
1. Add a home button to the top bar and connect it to the home page. - 10 min
...
# 9. Have a static image on the website
## S15
As an artist   
...
I Have included these user stories and requirements under each appropriate part above
